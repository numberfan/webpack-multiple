...
<template>
  <div class="scrollWarp" :id="containerId">
    <div class="listbox" :id="contentId">
      <div class="con">
        <slot name="list">
...
<script>
  export default {
    ...
    ready () {
      const domScroll = document.getElementById(this.containerId)
      const maincon = document.getElementById(this.contentId)
      domScroll.onscroll = () => {
